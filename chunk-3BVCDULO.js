import{a as c}from"./chunk-4XEE5PE3.js";import{a as s}from"./chunk-4LDVFWME.js";import{a as x}from"./chunk-7G56KLCZ.js";import{a as e}from"./chunk-47NSYSFY.js";var t=8,i=16;function a(){let o=new x;o.include(c),o.fragment.uniforms.add(new s("edgesTexture",r=>r.inputTexture),new s("areaTexture",r=>r.areaTexture),new s("searchTexture",r=>r.searchTexture)),o.fragment.constants.add("smaaAreaTexPixelSize","vec2",[1/160,1/560]);let d=1/7;return o.fragment.code.add(e`
    ...
    vec2 getArea(sampler2D areaTex, vec2 dist, float e1, float e2, float offset) {
      vec2 texcoord = float(${e.int(i)}) * round(4.0 * vec2(e1, e2)) + dist;
      texcoord = smaaAreaTexPixelSize * texcoord + (0.5 * smaaAreaTexPixelSize);
      texcoord.y += ${e.float(d)} * offset;
    ...
    vec4 maxOffset = vec4(offsets[0].xz, offsets[1].yw) + vec4(-2.0, 2.0, -2.0, 2.0) * resolution.xxyy * float(${e.int(t)});
    ...
    fragColor = weights;
  `),o}var v=Object.freeze(Object.defineProperty({__proto__:null,build:a},Symbol.toStringTag,{value:"Module"}));export{a,v as b};
