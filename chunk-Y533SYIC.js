import{a as U}from"./chunk-AIPTYQTX.js";import{a as g}from"./chunk-GVSOJUIP.js";import{a as j}from"./chunk-GWSX6PRO.js";import{a as P}from"./chunk-WOZSH7YY.js";import{a as R}from"./chunk-B2RVSTL3.js";import{a as F}from"./chunk-4XEE5PE3.js";import{a as u}from"./chunk-HUUJBVXR.js";import{a as G}from"./chunk-7G56KLCZ.js";import{h as I}from"./chunk-UKAGN54W.js";import{a as f}from"./chunk-T7PUQGWM.js";import{a as o}from"./chunk-47NSYSFY.js";import{b as T}from"./chunk-QSQIQSC6.js";import{e as E,j as z}from"./chunk-7SDNM7YV.js";import{a as y}from"./chunk-EM35R6FY.js";import{b as A}from"./chunk-QXXXCEV5.js";import{a as b,b as x,d as L,e as V,p as S,u as h,w as O,y as d}from"./chunk-6B5XFA6F.js";import{a as M}from"./chunk-PTZYZULI.js";import{l as v}from"./chunk-NMLYCCKN.js";import{a as m}from"./chunk-BOVYXYHK.js";import{i as w}from"./chunk-EQZWYK27.js";var B=w(6);function N(e){let r=new G;r.include(F),r.include(U,e);let t=r.fragment;if(e.lineVerticalPlaneEnabled||e.heightManifoldEnabled)if(t.uniforms.add(new u("maxPixelDistance",(i,n)=>e.heightManifoldEnabled?2*n.camera.computeScreenPixelSizeAt(i.heightManifoldTarget):2*n.camera.computeScreenPixelSizeAt(i.lineVerticalPlaneSegment.origin))),t.code.add(o`float planeDistancePixels(vec4 plane, vec3 pos) {
float dist = dot(plane.xyz, pos) + plane.w;
float width = fwidth(dist);
dist /= min(width, maxPixelDistance);
return abs(dist);
}`),e.spherical){let i=(a,c,_)=>d(a,c.heightManifoldTarget,_.camera.viewMatrix),n=(a,c)=>d(a,[0,0,0],c.camera.viewMatrix);t.uniforms.add(new g("heightManifoldOrigin",(a,c)=>(i(s,a,c),n(p,c),V(p,p,s),h(l,p),l[3]=b(p),l)),new j("globalOrigin",a=>n(s,a)),new u("cosSphericalAngleThreshold",(a,c)=>1-Math.max(2,S(c.camera.eye,a.heightManifoldTarget)*c.camera.perRenderPixelRatio)/b(a.heightManifoldTarget))),t.code.add(o`float globeDistancePixels(float posInGlobalOriginLength) {
...
}`)),t.main.add(o`fragColor = laserlineOutput(color * depthDiscontinuityAlpha);`),r}function D(e){return A(K,Math.cos(e.angleCutoff),Math.cos(Math.max(0,e.angleCutoff-w(2))))}function $(e,r){return d(C,e.pointDistanceOrigin,r.camera.viewMatrix),C[3]=S(e.pointDistanceOrigin,e.pointDistanceTarget),C}function k(e,r){let t=I(e.lineVerticalPlaneSegment,.5,s),i=e.renderCoordsHelper.worldUpAtPosition(t,Q),n=h(p,e.lineVerticalPlaneSegment.vector),a=O(s,i,n);return h(a,a),H(e.lineVerticalPlaneSegment.origin,a,r.camera.viewMatrix)}function q(e,r){let t=x(s,e.lineVerticalPlaneSegment.origin);return e.renderCoordsHelper.setAltitude(t,0),d(t,t,r.camera.viewMatrix)}function J(e,r){let t=L(s,e.lineVerticalPlaneSegment.origin,e.lineVerticalPlaneSegment.vector);return e.renderCoordsHelper.setAltitude(t,0),d(t,t,r.camera.viewMatrix)}function H(e,r,t){return d(W,e,t),x(l,r),l[3]=0,v(l,l,t),z(W,l,X)}var K=y(),s=m(),l=M(),Q=m(),p=m(),W=m(),X=E(),C=T(),De=Object.freeze(Object.defineProperty({__proto__:null,build:N,defaultAngleCutoff:B},Symbol.toStringTag,{value:"Module"}));export{B as a,N as b,De as c};
