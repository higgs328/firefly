import{a as d,b as O,d as T,e as m,f as $,h as L,j as W}from"./chunk-DBCWR6HP.js";import{b as M}from"./chunk-FRN24G7D.js";import{a as j}from"./chunk-GSXOR3JU.js";import{a as C}from"./chunk-55OTJIMU.js";import{a as w}from"./chunk-YEPHAEAY.js";import{c as S}from"./chunk-TK4PPGQL.js";import{b as x,c as y,d as P}from"./chunk-HMNTGQTR.js";import{a as z}from"./chunk-GVSOJUIP.js";import{a as D}from"./chunk-2PJRHNJW.js";import{a as g}from"./chunk-B2RVSTL3.js";import{a as u}from"./chunk-F6TN7E7K.js";import{a as b}from"./chunk-4LDVFWME.js";import{a as k}from"./chunk-7G56KLCZ.js";import{a as f}from"./chunk-WVKBXQWE.js";import{a as h}from"./chunk-SOEEM7Z7.js";import{a as r,b as n}from"./chunk-47NSYSFY.js";import{a as p}from"./chunk-RWCIDBNQ.js";function F(i){let e=new k,{space:v,anchor:N,hasTip:l}=i,s=v===d.World;e.include(T,i),e.include(W,i),e.include(j,i);let{vertex:o,fragment:c}=e;c.include(f),x(o,i),e.attributes.add(p.POSITION,"vec3"),e.attributes.add(p.PREVPOSITION,"vec3"),e.attributes.add(p.UV0,"vec2"),e.varyings.add("vColor","vec4"),e.varyings.add("vpos","vec3"),e.varyings.add("vUV","vec2"),e.varyings.add("vSize","float"),l&&e.varyings.add("vLineWidth","float"),o.uniforms.add(new u("nearFar",({camera:a})=>a.nearFar),new D("viewport",({camera:a})=>a.fullViewport)),o.code.add(r`vec4 projectAndScale(vec4 pos) {
...
}`),s?(e.attributes.add(p.NORMAL,"vec3"),y(o),o.constants.add("tiltThreshold","float",.7),o.code.add(r`vec3 perpendicular(vec3 v) {
...
return abs(cos) > 0.001 && t > 0.0;
}`),o.uniforms.add(new g("perScreenPixelRatio",({camera:a})=>a.perScreenPixelRatio)),o.code.add(r`
  ...
  `)),P(o),o.main.add(r`
    ...
    }`),e.fragment.include(S,i),e.include(M,i),c.uniforms.add(new z("intrinsicColor",a=>a.color),new b("tex",a=>a.markerTexture)),c.include(C),c.constants.add("texelSize","float",1/m),c.code.add(r`float markerAlpha(vec2 samplePos) {
